            ...
            <Card>
                <Box overflowX="auto">
                    <Table variant="simple" size="sm">
                        ...
                        <Tbody>
                            {loading ? (
                                <Tr><Td colSpan={9} textAlign="center"><Spinner size="lg" my={5} /></Td></Tr>
                            ) : complaints.length === 0 ? (
                                <Tr><Td colSpan={9} textAlign="center">No complaints found</Td></Tr>
                                ...
                                <Tr key={complaint.id} _hover={{ bg: tableHoverBg }}>
                                    ...
                                    <Td>{complaint.campusName || complaint.campusId || '—'}</Td>
