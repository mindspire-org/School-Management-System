        ...
        <Box pt={{ base: '130px', md: '80px', xl: '80px' }}>
            <Flex mb={5} justify="space-between" align="center" gap={3} flexWrap="wrap">
                <Box>
                    ...
                    <Text color={textColorSecondary}>Scan QR codes to mark teacher attendance</Text>
                </Box>
                <Button leftIcon={<MdQrCodeScanner />} colorScheme="blue">Start Scanner</Button>
            </Flex>
            <Card p={6}>
                <Text mb={4}>Scan teacher QR codes to mark attendance quickly and accurately.</Text>
